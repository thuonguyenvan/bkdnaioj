...
DROP TABLE IF EXISTS contest_phase_defs;
DROP TABLE IF EXISTS contests;
DROP TYPE  IF EXISTS leaderboard_mode;
DROP TYPE  IF EXISTS contest_phase_key;
DROP TYPE  IF EXISTS contest_entry_policy;
